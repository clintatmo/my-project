...
<style scoped>
    #dashWrap {
        min-height: 100%;
        padding-top: 0px;
        background: #cccc; /* fallback for old browsers */
        background: -webkit-linear-gradient(to left, #cccc , #fff); /* Chrome 10-25, Safari 5.1-6 */
        background: linear-gradient(to left, #cccc , #fff); /* W3C, IE 10+/ Edge, Firefox 16+, Chrome 26+, Opera 12+, Safari 7+ */
    }
</style>
